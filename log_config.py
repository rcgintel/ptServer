...
client_file_handler = logging.FileHandler(CLIENT_LOG_FILENAME)
client_file_handler.setLevel(CLIENT_CONSOLE_LEVEL)
...
server_file_handler.setLevel(SERVER_CONSOLE_LEVEL)
